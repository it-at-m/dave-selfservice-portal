...
describe("ValidationUtils -> checkForAlignmentOfIntervallsAccordingZaehldauer", () => {
  ...
  test("detects intervalls outside 24h bounds and returns them sorted and comma separated", () => {
    ...
    expect(
      ...
      "In der CSV-Datei befinden sich folgende Intervallnummern die sich ausserhalb des Zählzeitraums definiert durch die Zähldauer Ganztageszählung befinden: 0, 97"
    );
  });
