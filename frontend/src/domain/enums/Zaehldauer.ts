...
export const zaehldauerDropDown = new Array<KeyVal>(
    {
        ...
        text: zaehldauerText.get(Zaehldauer.DAUER_2_X_4_STUNDEN)!,
    },
    {
        value: Zaehldauer.DAUER_13_STUNDEN,
        text: zaehldauerText.get(Zaehldauer.DAUER_13_STUNDEN)!,
    },
    {
        value: Zaehldauer.DAUER_16_STUNDEN,
        text: zaehldauerText.get(Zaehldauer.DAUER_16_STUNDEN)!,
    },
    {
        value: Zaehldauer.DAUER_24_STUNDEN,
        text: zaehldauerText.get(Zaehldauer.DAUER_24_STUNDEN)!,
    },
    {
        value: Zaehldauer.SONSTIGE,
        text: zaehldauerText.get(Zaehldauer.SONSTIGE)!,
    }
);
