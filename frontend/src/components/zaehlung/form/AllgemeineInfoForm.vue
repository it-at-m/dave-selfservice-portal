  ...
  <v-sheet width="100%" :height="height" :max-height="height" class="overflow-y-auto">
    <v-card-text>
      <v-form ref="form" v-model="validZaehlung">
        <v-row dense>
          <v-col cols="12" md="4">
            <lhm-text-field caption="Projektnummer" :text="zaehlung.projektNummer"/>
          </v-col>
          <v-col cols="12" md="4">
            <lhm-text-field caption="Projektname" :text="zaehlung.projektName"/>
          </v-col>
          <v-col cols="12" md="4">
            <lhm-text-field caption="Sonderzählung" :text="getSonderzaehlungText"/>
          </v-col>
        </v-row>
        <v-row dense>
          <v-col cols="12" md="4">
            <v-menu v-if="isZaehlungInstructed"
                    v-model="menu"
                    ref="menu"
            ...
            <lhm-text-field v-else caption="Zählung am" :text="formattedDateAsText"/>
          </v-col>
          <v-col cols="12" md="4">
            <lhm-text-field caption="Zähldauer" :text="getZaehldauer"/>
          </v-col>
          <v-col cols="12" md="4">
            <lhm-text-field caption="Zählintervall" :text="getZaehlintervall"/>
          </v-col>
          <v-spacer/>
        </v-row>
        <v-row dense>
          <v-col cols="12" md="4">
            <v-autocomplete v-if="isZaehlungInstructed"
                            ...
                            @blur="updateStore"
            ></v-autocomplete>
            <lhm-text-field v-else caption="Zählart" :text="getZaehlart"/>
          </v-col>
          <v-col cols="12" md="4">
            <lhm-text-field caption="Quelle" :text="getQuelle"/>
          </v-col>
          <v-col cols="12" md="4">
            <v-autocomplete
