...
export default class ZaehlartIcon extends Vue {
  ...
  get icon() {
    if (!ZaehlartIcon.zaehlartIcons().has(this.zaehlart)) {
      return new IconOptions("mdi-help-box", "Keine Information zur Zählart")
    }
  ...
  static zaehlartIcons(): Map<string, IconOptions> {
    return new Map([
      ...
      [Zaehlart.H, new IconOptions("$artH", "Hauptverkehrsrichtung/Oberfläche/Hoch")],
      [Zaehlart.Q, new IconOptions("$artQ", "Querschnitt")],
      [Zaehlart.QB, new IconOptions("$artQB", "Bahnschnitt")],
      [Zaehlart.QH, new IconOptions("$artQH", "Querschnitt/Hauptverkehrsrichtung/Oberfläche/Hoch")],
      ...
      [Zaehlart.QT, new IconOptions("$artQT", "Querschnitt Tunnel/Unterführung/Tief")],
