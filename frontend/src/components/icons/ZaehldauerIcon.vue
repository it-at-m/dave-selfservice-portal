...
export default class ZaehldauerIcon extends Vue {
  ...
  get icon() {
    if (!ZaehldauerIcon.zaehldauerIcons().has(this.zaehldauer)) {
      return new IconOptions("mdi-help-box", "Keine Information zur Zähldauer")
    }
  ...
  static zaehldauerIcons(): Map<string, IconOptions> {
    return new Map([
      [Zaehldauer.DAUER_2_X_4_STUNDEN, new IconOptions("$zaehldauer2x4h", "2x4h Zählung")],
      [Zaehldauer.DAUER_24_STUNDEN, new IconOptions("$zaehldauer24h", "24h Zählung")],
      [Zaehldauer.DAUER_16_STUNDEN, new IconOptions("$zaehldauer16h", "16h Zählung")],
      [Zaehldauer.DAUER_13_STUNDEN, new IconOptions("$zaehldauer13h", "13h Zählung")],
      [Zaehldauer.SONSTIGE, new IconOptions("$zaehldauerSoZ", "Sonstige Zählung")]
    ])
  }
}
</script>